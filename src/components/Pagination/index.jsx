...
const Pagination = ({
    ...
    return (
        <div className="flex border-t-3 border-t-blue-400 flex-col md:flex-row justify-between items-center  p-4 bg-white rounded-lg shadow-sm">
            {showRowsPerPage && (
            ...
            <nav className="flex items-center space-x-1">
                ...
                <button
                    ...
                    className={`px-3 py-1 cursor-pointer rounded-md text-sm ${state.currentPage === 1
                        ...
                        : 'text-blue-400 hover:bg-blue-100 hover:text-blue-400'
                        }`}
                >
                    First
                </button>
